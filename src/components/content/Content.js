...
class Content extends Component {
  render() {
    return (
      <main className="Content" id="main-doc">
        ...
        <section className="main-section" id="Variable_scope">
            ...
            <article>
                ...
                <code>if (true) {'{'}<br/>&nbsp;&nbsp;let y = 5;<br/>{'}'}<br/>console.log(y);<br/>// ReferenceError: y is not defined</code>
            </article>
        </section>
        ...
        <section className="main-section" id="while_statement">
            ...
            <article>
                ...
                <code>while (condition) {'{'}<br/>&nbsp;&nbsp;statement_1;<br/>{'}'}</code>
